...
def _cv_style() -> dict[str, ParagraphStyle]:
    ...
    return {
        "name": ParagraphStyle(
            "cv_name", fontSize=18, leading=22, textColor=_DARK_BLUE, spaceAfter=4
        ),
        ...
        "small": ParagraphStyle(
            "cv_small", fontSize=8, leading=11, textColor=colors.HexColor("#555")
        ),
    }
...
def _generate_cv_pdf(profile: dict[str, Any]) -> bytes:
    ...
    header_info = " | ".join(x for x in [profile.get("email"), profile.get("phone")] if x)
    ...
    if objective:
        story.append(
            _section_heading(
                "MỤC TIÊU NGHỀ NGHIỆP" if profile.get("objective") else "TÓM TẮT CHUYÊN MÔN", styles
            )
        )
...
def _build_mime(
    ...
    body: str,
    *,
    recipient: str = "org@placeholder.invalid",
    ...
    return [
        ...
        (
            ...
            _build_mime(
                ...
                "kỹ năng của em. Chúng ta sẽ sắp xếp vòng phỏng vấn với CTO "
                "vào tuần sau. HR sẽ gửi calendar invite.\n\n"
                "Thân ái,\nHR Team",
            ),
        ),
        (
            ...
            _build_mime(
                "Nguyễn Thị Phương",
                "phuong.nguyen@recruitment-firm.vn",
                "Yêu cầu đổi lịch phỏng vấn — Ứng viên Nguyễn Văn Tâm",
                "Chào chị,\n\nỨng viên Nguyễn Văn Tâm có việc đột xuất, "
                "xin đổi lịch phỏng vấn từ 9h00 sang 14h00 cùng ngày 25/07.\n\n"
                "Nhờ chị xác nhận giúp.\n\nCảm ơn chị,\nPhương",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Tôi muốn hỏi về thủ tục nộp giấy tờ trong ngày đầu làm việc. "
        ...
        (
            ...
            _build_mime(
                ...
                "CCCD, sổ BHXH, giấy khám sức khỏe (đính kèm file scan).\n\n"
                "Vui lòng kiểm tra và xác nhận giúp tôi.\n\nTrân trọng,\nBình",
            ),
        ),
    ]
...
def _emails_leave_request() -> list[tuple[str, bytes]]:
    return [
        (
            ...
            _build_mime(
                "Trần Văn Hùng",
                "hung.tran@company.vn",
                "Xin nghỉ phép 3 ngày — Lý do gia đình",
                "Kính gửi Trưởng phòng,\n\nTôi viết email này để xin nghỉ phép 3 ngày "
                "từ 20/07/2025 đến 22/07/2025 vì lý do gia đình.\n\n"
                "Tôi đã bàn giao công việc cho anh Minh.\n\n"
        ...
        (
            ...
            _build_mime(
                ...
                "Tôi xin nghỉ ốm 1 ngày 19/07/2025.\n\n"
                "Tôi sẽ gửi giấy khám bệnh sau.\n\nCảm ơn.\nHương",
            ),
        ),
        (
            "leave_request",
            _build_mime(
                ...
                "Kính gửi Phòng HR và Trưởng phòng,\n\nTôi viết email để thông báo "
                "về việc xin nghỉ thai sản. Ngày dự sinh của vợ tôi là 15/08/2025. "
                "Tôi dự kiến nghỉ 5 ngày từ 14/08 đến 20/08/2025.\n\n"
                "Xin cảm ơn.\n\nPhạm Tuấn Kiệt",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Khoản giảm trừ thuế TNCN của tôi hình như cao hơn bình thường. "
                "Nhờ anh/chị kiểm tra lại giúp tôi.\n\nMã NV: EMP042\n\nCảm ơn.\nHương",
            ),
        ),
        (
            "payroll",
            _build_mime(
                ...
                "Không biết công ty đã có thông báo chính thức chưa?\n\n"
                "Cảm ơn anh/chị.\n\nHùng",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "thủ tục visa đi Singapore cho chuyến công tác tháng 8.\n\n"
                "Nhờ anh/chị hỗ trợ trong tuần này.\n\nCảm ơn.\nKiệt",
            ),
        ),
        (
            "employee_request",
            _build_mime(
                ...
                '"Kỹ năng Lãnh đạo" tổ chức vào tháng 9/2025.\n\n'
                "Nhờ anh/chị gửi thông tin chi tiết và form đăng ký.\n\nThanh",
            ),
        ),
        (
            "employee_request",
            _build_mime(
                ...
                "Số tài khoản mới: 1234567890123 — Ngân hàng Vietcombank, CN Hà Nội.\n\n"
                "Nhờ anh/chị cập nhật giúp. (Đây là dữ liệu test — không phải thật)\n\n"
                "Trân trọng,\nTuấn",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Kính gửi Trưởng phòng và Phòng HR,\n\n"
                "Tôi viết email này để chính thức nộp đơn xin nghỉ việc. "
                "Ngày làm việc cuối cùng của tôi là 15/08/2025.\n\n"
                "Tôi sẽ hoàn thành bàn giao công việc đầy đủ. Xin cảm ơn công ty "
                "đã tạo điều kiện làm việc trong 3 năm qua.\n\n"
                "Trân trọng,\nHoàng Minh Tuấn",
            ),
        ),
        (
            ...
            _build_mime(
                ...
                "Last working day: 31/08/2025.\n\n"
                "Nhờ HR hướng dẫn quy trình offboarding và các thủ tục liên quan "
                "(bảo hiểm, thuế, hoàn trả thiết bị).\n\nBest regards,\nBình",
            ),
        ),
    ]
...
def _emails_complaint() -> list[tuple[str, bytes]]:
    return [
        (
            ...
            _build_mime(
                "Nhân viên ẩn danh",
                "anonymous.worker@gmail.com",
                "Phản ánh về vấn đề quấy rối nơi làm việc",
                "Kính gửi Phòng HR,\n\nTôi muốn phản ánh về vấn đề quấy rối từ "
                "đồng nghiệp trong nhóm dự án. Sự việc đã diễn ra nhiều lần "
                "và ảnh hưởng nghiêm trọng đến hiệu suất làm việc của tôi.\n\n"
                "Mong Quý phòng xem xét và giải quyết.\n\nTrân trọng.",
            ),
        ),
        (
            "complaint",
            _build_mime(
                ...
                "Kính gửi Ban Giám đốc và Phòng HR,\n\nTôi viết email này để khiếu nại "
                "về quyết định kỷ luật ngày 15/07/2025. Tôi cho rằng quyết định này "
                "chưa dựa trên bằng chứng khách quan và đề nghị được xem xét lại.\n\n"
                "Tôi sẵn sàng gặp trực tiếp để làm rõ.\n\nTrân trọng,\nTrần Thị Mai",
            ),
        ),
    ]
...
def _emails_vendor() -> list[tuple[str, bytes]]:
    return [
        (
            ...
            _build_mime(
                "Nguyễn Văn Nam",
                "namnv@hrsolutions.vn",
                "Báo giá dịch vụ đào tạo doanh nghiệp 2025",
                "Kính gửi Quý Công ty,\n\nHR Solutions Vietnam xin gửi báo giá "
                "dịch vụ đào tạo:\n"
                "1. Kỹ năng Lãnh đạo: 40,000,000 VND/khóa (3 ngày)\n"
                "2. Kỹ năng Giao tiếp: 25,000,000 VND/khóa (2 ngày)\n"
                "3. Team Building: 50,000,000 VND/ngày\n\n"
        ...
        (
            ...
            _build_mime(
                "Trần Thị Hoa",
                "hoa.tran@teambuildingplus.com",
                "Chương trình Team Building 2025 — Ưu đãi đặc biệt",
                "Chào HR,\n\nTeambuilding Plus xin giới thiệu chương trình Team Building "
                '2025 với chủ đề "Kết nối & Bứt phá". Giá ưu đãi từ 2,000,000 '
                "đồng/người cho đoàn trên 100 người.\n\n"
                "Liên hệ: 090xxxxxxx\n\nTrân trọng,\nHoa",
            ),
        ),
        (
            ...
            _build_mime(
                "Lê Quang Bảo",
                "bao@recruitment-partners.vn",
                "Dịch vụ headhunt — Gói Premium",
                "Kính gửi HR Director,\n\nRecruitment Partners Vietnam cung cấp "
                "dịch vụ headhunt chuyên biệt cho vị trí C-level và quản lý cấp cao. "
                "Phí dịch vụ: 20% annual salary của ứng viên.\n\n"
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Tôi cần khám chuyên khoa tại Vinmec, không biết bảo hiểm "
                "có chi trả không và thủ tục như thế nào?\n\n"
                "Nhờ anh/chị hướng dẫn.\n\nThanh",
            ),
        ),
        (
            "insurance",
            _build_mime(
                employee_name := random.choice(_EMPLOYEE_NAMES),
                ...
                "Tôi cần chuẩn bị giấy tờ gì và mức hưởng như thế nào?\n\n"
                "Cảm ơn chị.",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "- Thời gian: 14h00, Thứ Sáu, 28/07/2025\n"
                "- Địa điểm: Phòng họp A, tầng 3\n\n"
                "Đề nghị tất cả nhân viên tham gia đầy đủ.\n\nTrân trọng,\nPhòng Nhân sự",
            ),
        ),
        (
            "internal",
            _build_mime(
                ...
                "Kính gửi các Trưởng phòng,\n\nBan Giám đốc đã phê duyệt ngân sách "
                "Marketing Q3/2025 như đề xuất. Chi tiết trong file đính kèm.\n\n"
                "Đề nghị triển khai theo kế hoạch.\n\nTrân trọng,\nBan Giám đốc",
            ),
        ),
    ]
...
def _emails_compliance() -> list[tuple[str, bytes]]:
    return [
        (
            "compliance",
            _build_mime(
                "Đoàn Thanh tra Sở LĐTBXH",
                "thanhtra@soldtbxh.gov.vn",
                "Thông báo thanh tra định kỳ — 05/08/2025",
                "Kính gửi Quý Công ty,\n\nĐoàn Thanh tra Sở LĐTBXH sẽ tiến hành "
                "thanh tra định kỳ vào ngày 05/08/2025.\n\n"
                "Đề nghị chuẩn bị: Hợp đồng lao động, Sổ BHXH, Bảng chấm công, "
                "Quy chế trả lương.\n\nTrân trọng,\nĐoàn Thanh tra",
            ),
        ),
        (
            ...
            _build_mime(
                ...
                "thuế TNCN quý 2/2025 trước ngày 30/07/2025.\n\n"
                "Mọi thắc mắc liên hệ: 024.xxxxxxx\n\nTrân trọng.",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Hệ thống Vroom HR thông báo:\n\n"
                "Lịch sao lưu dữ liệu đã hoàn tất lúc 02:00 AM 19/07/2025.\n"
                "Dung lượng: 1.2 GB. Trạng thái: Thành công.\n\n"
        ...
        (
            ...
            _build_mime(
                ...
                "- CVE-2025-xxxx (High) in package requests==2.28.1\n"
                "- CVE-2025-yyyy (Medium) in package certifi==2023.5.7\n\n"
                "View alerts: https://github.com/org/repo/security\n\nGitHub",
            ),
        ),
    ]
    ...
    return [
        (
            ...
            _build_mime(
                ...
                "Nhớ mang theo cuốn sách anh mượn nhé.\n\nHẹn gặp lại,\nHuy",
            ),
        ),
        (
            "uncategorized",
            _build_mime(
                ...
                "đừng thức khuya quá. Cuối tuần về nhà mẹ nấu cháo gà cho ăn.\n\n"
                "Thương con,\nMẹ",
            ),
        ),
    ]
...
async def _send_email(
    http_client: httpx.AsyncClient, access_token: str, mime_bytes: bytes
) -> dict[str, str]:
...
async def main() -> None:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Print email list without inserting")
    parser.add_argument(
    ...
    async with httpx.AsyncClient(timeout=30.0) as http_client:
        ...
        for i, (cat, label, mime) in enumerate(all_emails, 1):
            try:
                ...
                print(
                    f"[{i:3d}/{len(all_emails)}] \u2713 {cat:20s} | {label:45s} | id={msg_id[:20]}..."
                )
                success += 1
            except httpx.HTTPStatusError as exc:
                print(
                    f"[{i:3d}/{len(all_emails)}] \u2717 {cat:20s} | {label:45s} | HTTP {exc.response.status_code}"
                )
