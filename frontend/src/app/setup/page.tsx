  ...
  return (
    <main className="min-h-screen bg-background lg:grid lg:grid-cols-[minmax(280px,0.8fr)_minmax(480px,1.2fr)]">
      <aside className="hidden flex-col justify-between bg-foreground p-10 text-background lg:flex xl:p-16">
        <div><div className="mb-16 flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary font-semibold">V</span><span className="font-semibold tracking-wide">Vroom HR</span></div><p className="mb-4 font-mono text-xs uppercase tracking-[0.2em] text-background/60">First-Run Setup</p><h1 className="max-w-md text-5xl leading-tight">Bắt đầu một cách rõ ràng.</h1><p className="mt-6 max-w-sm text-sm leading-6 text-background/70">Xác lập Organization và tạo tài khoản HR đầu tiên cho deployment của bạn.</p></div>
      ...
      <section className="flex min-h-screen items-center justify-center p-5 sm:p-10"><div className="w-full max-w-xl">
        ...
        <div className="mb-8"><p className="font-mono text-xs uppercase tracking-[0.18em] text-muted-foreground">Thiết lập lần đầu</p><h2 className="mt-2 text-4xl leading-tight">Thiết lập Organization</h2><p className="mt-3 text-sm text-muted-foreground">Tạo không gian làm việc và tài khoản HR đầu tiên.</p></div>
