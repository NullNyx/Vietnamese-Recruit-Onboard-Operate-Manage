...
export default function AttendanceError({
  ...
  return (
    <div className="space-y-6">
      <PageHeader icon={Clock} title="Chấm công & Allowlist" subtitle="Đã xảy ra lỗi khi tải trang quản lý chấm công." />
      <Card>
        <div className="text-center py-8 space-y-3">
          <p className="text-sm text-slate-600">Không thể hiển thị trang quản lý chấm công. Vui lòng thử lại.</p>
