...
- Name: role-based-accessibility.spec.ts >> HR accessibility @hr >> search dialog: focus management, accessible name and description
- Location: e2e/role-based-accessibility.spec.ts:101:7
  ...
  - generic [ref=e2]:
    - banner [ref=e3]:
      - navigation "Điều hướng chính" [ref=e4]:
        ...
        - generic [ref=e29]:
          - button "Tìm kiếm (Ctrl+K)" [active] [ref=e30] [cursor=pointer]:
            - img
            - generic:
              - generic: ⌘
              - text: K
...
```ts
  ...
  27  | }
  28  | 
  29  | const isoNow = new Date().toISOString();
  30  | 
  31  | const hrUser = {
  32  |   id: "14717ef2-869a-4725-a650-b410c7ba05d9",
  33  |   email: "hr.qa@vroom.example.com",
  34  |   name: "HR QA",
  35  |   avatar_url: null,
  36  |   employee_id: null,
  37  |   role: "admin" as const,
  38  |   must_change_password: false,
  39  |   gmail_grant_valid: true,
  40  |   calendar_grant_valid: true,
  41  |   created_at: isoNow,
  42  |   last_login: isoNow,
  43  | };
  44  | 
  45  | const employeeUser = {
  46  |   id: "cdca7ee1-3ea1-4f56-b5e9-6f1b6ce72ddd",
  47  |   email: "employee.qa@vroom.example.com",
  48  |   name: "Employee QA",
  49  |   avatar_url: null,
  50  |   employee_id: "abd76375-8303-4fad-a69f-89b2ffe9d63c",
  51  |   role: "user" as const,
  52  |   must_change_password: false,
  53  |   gmail_grant_valid: true,
  54  |   calendar_grant_valid: true,
  55  |   created_at: isoNow,
  56  |   last_login: isoNow,
  57  | };
  58  | 
  59  | async function mockAuthenticatedShell(page: Page, user: typeof hrUser | typeof employeeUser) {
  60  |   await page.context().addCookies([
  61  |     {
  ...
  68  |     ([storageKey, currentUser]) => {
  69  |       window.localStorage.setItem(storageKey, JSON.stringify(currentUser));
  70  |       window.__VROOM_HR_E2E_CURRENT_USER__ = currentUser;
  71  |     },
