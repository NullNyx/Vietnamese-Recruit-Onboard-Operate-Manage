...
- Name: assistant-feedback.spec.ts >> HR assistant feedback @hr >> clicking thumbs up submits feedback and shows Đã đánh giá
- Location: e2e/assistant-feedback.spec.ts:53:7
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      - generic [ref=e6]: V
      - heading "Vroom HR" [level=1] [ref=e7]
      - paragraph [ref=e8]: Đăng nhập vào hệ thống
    - generic [ref=e9]:
      - img [ref=e10]
      - generic [ref=e12]: Không thể kiểm tra trạng thái khởi tạo
    - generic [ref=e13]:
      - generic [ref=e14]:
        - text: Email
