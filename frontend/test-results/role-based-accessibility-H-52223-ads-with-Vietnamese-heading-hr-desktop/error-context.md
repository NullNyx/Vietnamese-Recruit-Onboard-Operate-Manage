...
- Name: role-based-accessibility.spec.ts >> HR accessibility @hr >> recruitment page states @hr >> recruitment page loads with Vietnamese heading
- Location: e2e/role-based-accessibility.spec.ts:206:9
